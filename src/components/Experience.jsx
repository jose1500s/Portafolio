export default function Experience() {
    return (
        <section className="mt-5 py-4 w-5/12 max-[740px]:w-3/4 right-0 left-0 m-auto" id="experiencia">
            ...
            <ol className="border-s border-neutral-400 max-h-full">
                <li className="relative mb-16 ms-4">
                    ...
                    <article>
                        ...
                        <h3 className="text-lg font-semibold text-sky-300 mb-1">Software Intern - HARMAN Mex.</h3>
                        <p className="text-pretty text-neutral-200">
                            Se implemento un nuevo módulo de software para el sistema ERP de la empresa, el cual permitió digitalizar el proceso de certificación de todo el personal en lineas de producción, eliminando por completo los gastos que este proceso generaba y ahorrando hasta un 50% en el tiempo invertido.
                        </p>
                        <ul className="flex flex-wrap gap-4 mt-3">
                            <li>
                                <span className=" flex gap-2 items-center py-1 px-2 rounded-lg font-medium
                                        bg-[#1D1F20] text-[#F5F5F5] bg-clip-padding backdrop-filter backdrop-blur-2xl bg-opacity-[58%] border border-white border-opacity-25
                                    ">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="1.9em" height="1em" viewBox="0 0 256 135"><defs><radialGradient id="logosPhp0" cx=".837" cy="-125.811" r="363.057" gradientTransform="translate(76.464 81.918)scale(.463)" gradientUnits="userSpaceOnUse"><stop offset="0" stopColor="#FFF"></stop><stop offset=".5" stopColor="#4C6B97"></stop><stop offset="1" stopColor="#231F20"></stop></radialGradient></defs><ellipse cx="128" cy="67.3" fill="url(#logosPhp0)" rx="128" ry="67.3"></ellipse><ellipse cx="128" cy="67.3" fill="#6181B6" rx="123" ry="62.3"></ellipse><path fill="#FFF" d="m152.9 87.5l6.1-31.4c1.4-7.1.2-12.4-3.4-15.7c-3.5-3.2-9.5-4.8-18.3-4.8h-10.6l3-15.6c.1-.6 0-1.2-.4-1.7s-.9-.7-1.5-.7h-14.6c-1 0-1.8.7-2 1.6l-6.5 33.3c-.6-3.8-2-7-4.4-9.6c-4.3-4.9-11-7.4-20.1-7.4H52.1c-1 0-1.8.7-2 1.6L37 104.7c-.1.6 0 1.2.4 1.7s.9.7 1.5.7h14.7c1 0 1.8-.7 2-1.6l3.2-16.3h10.9c5.7 0 10.6-.6 14.3-1.8c3.9-1.3 7.4-3.4 10.5-6.3c2.5-2.3 4.6-4.9 6.2-7.7l-2.6 13.5c-.1.6 0 1.2.4 1.7s.9.7 1.5.7h14.6c1 0 1.8-.7 2-1.6l7.2-37h10c4.3 0 5.5.8 5.9 1.2c.3.3.9 1.5.2 5.2L134.1 87c-.1.6 0 1.2.4 1.7s.9.7 1.5.7h15c.9-.3 1.7-1 1.9-1.9m-67.6-26c-.9 4.7-2.6 8.1-5.1 10c-2.5 1.9-6.6 2.9-12 2.9h-6.5l4.7-24.2h8.4c6.2 0 8.7 1.3 9.7 2.4c1.3 1.6 1.6 4.7.8 8.9m130-18.6c-4.3-4.9-11-7.4-20.1-7.4h-28.3c-1 0-1.8.7-2 1.6l-13.1 67.5c-.1.6 0 1.2.4 1.7s.9.7 1.5.7h14.7c1 0 1.8-.7 2-1.6l3.2-16.3h10.9c5.7 0 10.6-.6 14.3-1.8c3.9-1.3 7.4-3.4 10.5-6.3c2.6-2.4 4.8-5.1 6.4-8c1.6-2.9 2.8-6.1 3.5-9.6c1.7-8.7.4-15.5-3.9-20.5M200 61.5c-.9 4.7-2.6 8.1-5.1 10c-2.5 1.9-6.6 2.9-12 2.9h-6.5l4.7-24.2h8.4c6.2 0 8.7 1.3 9.7 2.4c1.4 1.6 1.7 4.7.8 8.9"></path><path fill="#000004" d="M74.8 48.2c5.6 0 9.3 1 11.2 3.1c1.9 2.1 2.3 5.6 1.3 10.6c-1 5.2-3 9-5.9 11.2c-2.9 2.2-7.3 3.3-13.2 3.3h-8.9l5.5-28.2zM39 105h14.7l3.5-17.9h12.6c5.6 0 10.1-.6 13.7-1.8c3.6-1.2 6.8-3.1 9.8-5.9c2.5-2.3 4.5-4.8 6-7.5s2.6-5.7 3.2-9c1.6-8 .4-14.2-3.5-18.7s-10.1-6.7-18.6-6.7H52.1zm74.3-85.4h14.6l-3.5 17.9h13c8.2 0 13.8 1.4 16.9 4.3c3.1 2.9 4 7.5 2.8 13.9L151 87.1h-14.8l5.8-29.9c.7-3.4.4-5.7-.7-6.9c-1.1-1.2-3.6-1.9-7.3-1.9h-11.7l-7.5 38.7h-14.6zm76.2 28.6c5.6 0 9.3 1 11.2 3.1c1.9 2.1 2.3 5.6 1.3 10.6c-1 5.2-3 9-5.9 11.2c-2.9 2.2-7.3 3.3-13.2 3.3H174l5.5-28.2zM153.7 105h14.7l3.5-17.9h12.6c5.6 0 10.1-.6 13.7-1.8c3.6-1.2 6.8-3.1 9.8-5.9c2.5-2.3 4.5-4.8 6-7.5s2.6-5.7 3.2-9c1.6-8 .4-14.2-3.5-18.7s-10.1-6.7-18.6-6.7h-28.3z"></path></svg>
                                    PHP
                                </span>
                            </li>
                            <li>
                                <span className=" flex gap-2 items-center py-1 px-2 rounded-lg font-medium
                                        bg-[#1D1F20] text-[#F5F5F5] bg-clip-padding backdrop-filter backdrop-blur-2xl bg-opacity-[58%] border border-white border-opacity-25
                                    ">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="1.2em" height="1.2em" viewBox="0 0 256 256"><g fill="none"><rect width="256" height="256" fill="#F0DB4F" rx="60"></rect><path fill="#323330" d="m67.312 213.932l19.59-11.856c3.78 6.701 7.218 12.371 15.465 12.371c7.905 0 12.889-3.092 12.889-15.12v-81.798h24.058v82.138c0 24.917-14.606 36.259-35.916 36.259c-19.245 0-30.416-9.967-36.087-21.996m85.07-2.576l19.588-11.341c5.157 8.421 11.859 14.607 23.715 14.607c9.969 0 16.325-4.984 16.325-11.858c0-8.248-6.53-11.17-17.528-15.98l-6.013-2.579c-17.357-7.388-28.871-16.668-28.871-36.258c0-18.044 13.748-31.792 35.229-31.792c15.294 0 26.292 5.328 34.196 19.247l-18.731 12.029c-4.125-7.389-8.591-10.31-15.465-10.31c-7.046 0-11.514 4.468-11.514 10.31c0 7.217 4.468 10.139 14.778 14.608l6.014 2.577c20.449 8.765 31.963 17.699 31.963 37.804c0 21.654-17.012 33.51-39.867 33.51c-22.339 0-36.774-10.654-43.819-24.574"></path></g></svg>
                                    Javascript
                                </span>
                            </li>
                            <li>
                                <span className=" flex gap-2 items-center py-1 px-2 rounded-lg font-medium
                                        bg-[#1D1F20] text-[#F5F5F5] bg-clip-padding backdrop-filter backdrop-blur-2xl bg-opacity-[58%] border border-white border-opacity-25
                                    ">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="1.39em" height="1.2em" viewBox="0 0 256 185"><path fill="#2396ED" d="M250.716 70.497c-5.765-4-18.976-5.5-29.304-3.5c-1.2-10-6.725-18.749-16.333-26.499l-5.524-4l-3.844 5.75c-4.803 7.5-7.205 18-6.485 28c.24 3.499 1.441 9.749 5.044 15.249c-3.362 2-10.328 4.5-19.455 4.5H1.155l-.48 2c-1.682 9.999-1.682 41.248 18.014 65.247c14.892 18.249 36.99 27.499 66.053 27.499c62.93 0 109.528-30.25 131.386-84.997c8.647.25 27.142 0 36.51-18.75c.24-.5.72-1.5 2.401-5.249l.961-2zM139.986 0h-26.42v24.999h26.42zm0 29.999h-26.42v24.999h26.42zm-31.225 0h-26.42v24.999h26.42zm-31.225 0H51.115v24.999h26.421zM46.311 59.998H19.89v24.999h26.42zm31.225 0H51.115v24.999h26.421zm31.225 0h-26.42v24.999h26.42zm31.226 0h-26.422v24.999h26.422zm31.225 0H144.79v24.999h26.422z"></path></svg>
                                    Docker
                                </span>
                            </li>
                            <li>
                            ...
                            <li>
                                <span className=" flex gap-2 items-center py-1 px-2 rounded-lg font-medium
                                        bg-[#1D1F20] text-[#F5F5F5] bg-clip-padding backdrop-filter backdrop-blur-2xl bg-opacity-[58%] border border-white border-opacity-25
                                    ">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="1.2em" height="1.2em" viewBox="0 0 256 256"><defs><linearGradient id="logosJira0" x1="98.031%" x2="58.888%" y1=".161%" y2="40.766%"><stop offset="18%" stopColor="#0052CC"></stop><stop offset="100%" stopColor="#2684FF"></stop></linearGradient><linearGradient id="logosJira1" x1="100.665%" x2="55.402%" y1=".455%" y2="44.727%"><stop offset="18%" stopColor="#0052CC"></stop><stop offset="100%" stopColor="#2684FF"></stop></linearGradient></defs><path fill="#2684FF" d="M244.658 0H121.707a55.502 55.502 0 0 0 55.502 55.502h22.649V77.37c.02 30.625 24.841 55.447 55.466 55.467V10.666C255.324 4.777 250.55 0 244.658 0"></path><path fill="url(#logosJira0)" d="M183.822 61.262H60.872c.019 30.625 24.84 55.447 55.466 55.467h22.649v21.938c.039 30.625 24.877 55.43 55.502 55.43V71.93c0-5.891-4.776-10.667-10.667-10.667"></path><path fill="url(#logosJira1)" d="M122.951 122.489H0c0 30.653 24.85 55.502 55.502 55.502h22.72v21.867c.02 30.597 24.798 55.408 55.396 55.466V133.156c0-5.891-4.776-10.667-10.667-10.667"></path></svg>
                                    Jira
                                </span>
                            </li>
                        </ul>
                ...
                <li className="ms-4 relative">
                    ...
                    <article>
                        ...
                        <h3 className="text-lg font-semibold text-sky-300 mb-1">Software Developer - UPQ</h3>
                        <p className="text-pretty text-neutral-200">
                            Se implemento un sistema de información para el área de servicios estudiantiles, donde es posible llevar un control de distintos indicadores importantes del área, así como generar reportes y estadísticas de los mismos.
                        </p>
                        <ul className="flex flex-wrap gap-4 mt-3">
                            <li>
                                <span className=" flex gap-2 items-center py-1 px-2 rounded-lg font-medium
                            ...
                            <li>
                                <span className=" flex gap-2 items-center py-1 px-2 rounded-lg font-medium
                                        bg-[#1D1F20] text-[#F5F5F5] bg-clip-padding backdrop-filter backdrop-blur-2xl bg-opacity-[58%] border border-white border-opacity-25
                                    ">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 256 256"><g fill="#888888"><path d="M216 64a24 24 0 1 1-24-24a24 24 0 0 1 24 24" opacity=".2"></path><path d="M224 64a32 32 0 1 0-40 31v9a16 16 0 0 1-16 16H96a31.71 31.71 0 0 0-16 4.31V95a32 32 0 1 0-16 0v66a32 32 0 1 0 16 0v-9a16 16 0 0 1 16-16h72a32 32 0 0 0 32-32v-9a32.06 32.06 0 0 0 24-31M56 64a16 16 0 1 1 16 16a16 16 0 0 1-16-16m32 128a16 16 0 1 1-16-16a16 16 0 0 1 16 16M192 80a16 16 0 1 1 16-16a16 16 0 0 1-16 16"></path></g></svg>
                                    Git y GitHub
                                </span>
                            </li>
                            <li>
                                <span className=" flex gap-2 items-center py-1 px-2 rounded-lg font-medium
                                        bg-[#1D1F20] text-[#F5F5F5] bg-clip-padding backdrop-filter backdrop-blur-2xl bg-opacity-[58%] border border-white border-opacity-25
                                    ">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="1.67em" height="1em" viewBox="0 0 256 154"><defs><linearGradient id="logosTailwindcssIcon0" x1="-2.778%" x2="100%" y1="32%" y2="67.556%"><stop offset="0%" stopColor="#2298BD"></stop><stop offset="100%" stopColor="#0ED7B5"></stop></linearGradient></defs><path fill="url(#logosTailwindcssIcon0)" d="M128 0C93.867 0 72.533 17.067 64 51.2C76.8 34.133 91.733 27.733 108.8 32c9.737 2.434 16.697 9.499 24.401 17.318C145.751 62.057 160.275 76.8 192 76.8c34.133 0 55.467-17.067 64-51.2c-12.8 17.067-27.733 23.467-44.8 19.2c-9.737-2.434-16.697-9.499-24.401-17.318C174.249 14.743 159.725 0 128 0M64 76.8C29.867 76.8 8.533 93.867 0 128c12.8-17.067 27.733-23.467 44.8-19.2c9.737 2.434 16.697 9.499 24.401 17.318C81.751 138.857 96.275 153.6 128 153.6c34.133 0 55.467-17.067 64-51.2c-12.8 17.067-27.733 23.467-44.8 19.2c-9.737-2.434-16.697-9.499-24.401-17.318C110.249 91.543 95.725 76.8 64 76.8"></path></svg>
                                    Tailwind CSS
                                </span>
                            </li>
                        </ul>
